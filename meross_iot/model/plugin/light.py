...
class LightInfo(object):
    def __init__(self, rgb: Union[int, Tuple[int, int, int]] = None, luminance: int = None, temperature: int = None):
    ...
    def update(self, rgb: Union[int, RgbTuple] = None, luminance: int = None, temperature: int = None, *args, **kwargs):
        if rgb is not None:
            self._rgb = self._convert_rgb(rgb)
