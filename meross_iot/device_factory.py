...
from meross_iot.controller.mixins.thermostat import ThermostatModeMixin, ThermostatModeBMixin, ThermostatCalibrationMixin
...
_ABILITY_MATRIX = {
    ...
    Namespace.CONTROL_THERMOSTAT_CALIBRATION.value: ThermostatCalibrationMixin
